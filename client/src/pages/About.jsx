...
const AboutPage = () => {
  return (
    <div className="container mx-auto md:px-4 py-8 w-3/4  min-h-[77vh]">
      <h1 className="text-2xl md:text-3xl font-bold mb-4 text-yellow-400">About GovindEstate</h1>
      <p className="md:text-lg mb-4 text-gray-700">
        Govind Estate is dedicated to helping you find your perfect space.
        Whether you are looking to buy or rent, we provide listings that match
        your needs and preferences. Our goal is to make the process of finding a
        home easy, fast, and comfortable for you.
      </p>
      <p className="md:text-lg mb-4 text-gray-700">
