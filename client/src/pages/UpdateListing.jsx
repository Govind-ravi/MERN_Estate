...
export default function CreateListing() {
    ...
    useEffect(()=>{
        const fetchListing = async ()=>{
            ...
            if(data.success===false) return console.log('Not found')
            setFormData(data)
        }
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-2'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <input type="text" placeholder='Address' className='border p-3 rounded-lg' id='address' maxLength='62' minLength='5' required onChange={handleChange} value={formData.address}/>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                <p className='font-semibold'>Iamges:
                    <span className='font-normal text-gray-600 ml-2'>The first image will be the cover (max 6)</span>
                </p>
                <div className='flex gap-4'>
                    <input onChange={(e)=>setFiles(e.target.files)} type="file" id='images' accept='image/*' multiple className='p-3 border border-gray-300 rounder w-full'/>
                ...
                formData.imageURLs.length>0 && formData.imageURLs.map((url, index)=>(
                    ...
                    <img src={url} alt="Listing image" className='w-25 h-20 object-cover rounded-lg'/>
            ...
            {submitted && <p className='text-green-700 text-sm'>Successfully Submitted</p>}
