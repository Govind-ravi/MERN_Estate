                    ...
                    <div>
                      ...
                      <p className="flex items-center text-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M10 2a5 5 0 00-5 5v5a1 1 0 001 1h8a1 1 0 001-1V7a5 5 0 00-5-5zm3 10v1a1 1 0 01-1 1H8a1 1 0 01-1-1v-1h6z" clipRule="evenodd" />
                        </svg>
                        {listing.address}
                      </p>
                    </div>
                    {listing.offer && (
                      <p className="text-green-600">{calculateOfferPercentage(listing.regularPrice, listing.discountPrice)}% off</p>
                    )}
                  </div>
                  <p className="text-gray-700 truncate">{listing.description}</p>
                  <div className="flex justify-between items-center mt-2">
                    <p className="text-gray-900 font-semibold">${listing.regularPrice}</p>
                    <Link to={`/listing/${listing._id}`} className="text-blue-500 hover:underline flex items-center">
    ...
    <div className="relative min-h-screen">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden h-[70vh]">
        <video className="w-full h-full object-cover" autoPlay loop muted>
          <source src="https://cdn.pixabay.com/video/2022/10/31/137210-766502986_large.mp4" type="video/mp4" />
        </video>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center text-white bg-black bg-opacity-50 p-10 h-[70vh]">
        <h1 className="text-4xl md:text-6xl font-bold">Discover Your Perfect Space</h1>
        <p className="mt-4 text-lg md:text-xl">
          Govind Estate helps you find your home with speed, ease, and comfort.
        </p>
        <Link to="/search" className="mt-8 text-white bg-blue-500 p-3 rounded font-semibold hover:underline">Let's Get Started...</Link>
      </div>
        ...
        <section className="py-12">
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            ...
            {recentOffers.length > 0 && (
              <Link to="/search?offer=true" className="text-blue-500 flex items-center hover:underline">
        ...
        <section className="py-12 bg-gray-100">
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            ...
            {recentRentals.length > 0 && (
              <Link to="/search?type=rent" className="text-blue-500 flex items-center hover:underline">
        ...
        <section className="py-12">
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            ...
            {recentSales.length > 0 && (
              <Link to="/search?type=sale" className="text-blue-500 flex items-center hover:underline">
      ...
      <div className="w-full mb-4 md:mb-0">
        <div className="flex items-center">
          ...
          <ul className=" flex space-x-6 font-semibold text-lg">
            <li><a href="/search" className="hover:text-gray-300">Get Started</a></li>
            <li><a href="/search?type=rent" className="hover:text-gray-300">Rentals</a></li>
            <li><a href="/search?type=sale" className="hover:text-gray-300">Sales</a></li>
            <li><a href="/search?offer=true" className="hover:text-gray-300">Offers</a></li>
            <li><a href="/your-listings" className="hover:text-gray-300">Your Listings</a></li>
          </ul>
        </div>
      </div>
      <div className="w-full text-center">
        <p className="text-sm">&copy; {new Date().getFullYear()} Govind Estate. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
