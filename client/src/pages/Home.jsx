...
export default function Home() {
              ...
              <Link to={`/listing/${listing._id}`} className="block">
                ...
                <div className="p-4">
                  <div className="flex justify-between items-center mb-2">
                    <div>
                      <h3 className="text-lg sm:text-xl font-bold">{listing.name}</h3>
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Headline Section */}
      <div className="relative z-10 flex flex-col items-center justify-center text-center text-white bg-black bg-opacity-50 p-6 h-[70vh]">
        ...
        <Link
          to="/search"
          className="mt-8 text-white bg-blue-500 px-4 py-2 rounded font-semibold hover:underline"
        >
          Let's Get Started...
        </Link>
      </div>
      ...
      <div className="relative z-20 bg-white">
        ...
        <section className="py-12">
          <div className="max-w-6xl mx-auto flex justify-between items-center px-4">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Recent Offers</h2>
        ...
        <section className="py-12 bg-gray-100">
          <div className="max-w-6xl mx-auto flex justify-between items-center px-4">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Recent Rentals</h2>
        ...
        <section className="py-12">
          <div className="max-w-6xl mx-auto flex justify-between items-center px-4">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Recent Sales</h2>
