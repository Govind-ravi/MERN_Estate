      ...
      <div className="w-full max-w-md bg-white px-8 py-4 rounded shadow-md flex flex-col">
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red-600">
              {" "}
              Error in Image Upload(Size less than 2MB)
            </span>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-2 mb-6">
            ...
            <Link
              className="w-full py-2 px-4 text-center border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-80"
              to={"/create-listing"}
            >
              Create Listing
            </Link>
        ...
        <Link className="underline text-gray-700 mt-2" to="/userlistings">
          Your Listings
        </Link>
      </div>
    </div>
